   ...
   <main class="max-w-5xl mx-auto px-6 py-10">
        ...
        <div id="mainMenu">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                <!-- Chức năng 1 -->
                <div class="menu-card" onclick="window.location.href = 'code1.php'">
                ...
                <!-- Chức năng 2 -->
                <div class="menu-card" onclick="window.location.href = 'code2.php'">
                ...
                <!-- Chức năng 3 -->
                <div class="menu-card" onclick="window.location.href = 'code3.php'">
                ...
                <!-- Chức năng 4 -->
                <div class="menu-card" onclick="window.location.href = 'code5.php'">
                    <div class="title">HÌNH HỌC</div>
                    <div class="subtitle" style="color: #f97316;">hình học căn bản</div>
                    <div class="desc">
                        • Tam giác (đồng dạng, vuông, cân)<br>
                        • Đường tròn (tiếp tuyến, cung, góc nội tiếp)<br>
                        • Hệ thức lượng trong tam giác vuông<br>
                        • Chứng minh hình học
                    </div>
                </div>
                
                <!-- Chức năng 5 -->
                <div class="menu-card" onclick="window.location.href = 'code6.php'">
                    <div class="title">THỐNG KÊ VÀ XÁC SUẤT</div>
                    <div class="subtitle" style="color: #10b981;">Thống kê và xác suất cơ bản</div>
                    <div class="desc">
                        • Các số đặc trưng mẫu số liệu<br>
                        • Quy tắc cộng, nhân, tổ hợp<br>
                        • Tính xác suất cơ bản<br>
                        &nbsp;
                    </div>
                </div>
        ...
        <script>
            ...
            const SYSTEM_PROMPT = `Bạn là chuyên gia giáo dục Toán học Việt Nam.
            NHIỆM VỤ: Biên soạn 50 câu hỏi trắc nghiệm Toán 10 thi tuyển sinh (Ma trận 2026-2027).
            PHÂN BỔ:
            - 24 câu Đại số (Căn thức, Hệ PT, y=ax^2, Vi-ét, BĐT Cô-si).
            - 19 câu Hình học (Hệ thức lượng, Tiếp tuyến, Tứ giác nội tiếp, Diện tích/Thể tích khối).
            - 7 câu Thống kê & Xác suất (Bảng số liệu, biểu đồ, xác suất đơn giản).
            ĐỊNH DẠNG TOÁN HỌC: Không dùng $. Dùng văn bản rõ ràng (x^2, căn bậc hai của x, delta...).
            ...
            generateBtn.addEventListener('click', async () => {
                ...
                try {
                    ...
                    alert("Lỗi kết nối AI. Hãy chắc chắn API Key hợp lệ và kết nối mạng ổn định.");
                } finally {
